...
public class CustomizedResponseEntityExceptionHandlerTest {
	...
	@Test
	public void handleNoRecordFoundExceptions() throws Exception {
		
		NoRecordFoundException noRecordFoundException = new NoRecordFoundException("message");
		
		ResponseEntity<Object> noRecordFoundExceptionResponse = customizedResponseEntityExceptionHandler.handleNoRecordFoundExceptions(noRecordFoundException, webrequest);
		
		assertEquals("404 NOT_FOUND", noRecordFoundExceptionResponse.getStatusCode().toString());
