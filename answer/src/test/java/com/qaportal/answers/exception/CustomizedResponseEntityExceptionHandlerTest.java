...
public class CustomizedResponseEntityExceptionHandlerTest {
	...
	@Test
	public void answersNotFoundExceptionHandlerTest() throws Exception {
		
		AnswersNotFoundException answersNotFoundException = new AnswersNotFoundException(1);
		
		ResponseEntity<Object> answersNotFoundExceptionHandlerResponse = customizedResponseEntityExceptionHandler.AnswersNotFoundExceptionHandler(answersNotFoundException, webrequest);
		
		assertEquals("400 BAD_REQUEST", answersNotFoundExceptionHandlerResponse.getStatusCode().toString());
